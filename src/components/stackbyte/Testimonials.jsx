      ...
      <div className="mx-auto max-w-3xl px-6 text-center">
        ...
        <div className="mt-8 flex items-center justify-center gap-3">
          ...
          <div className="text-left">
            <div className="font-['ClashDisplay-Regular'] text-sm font-medium text-white">Renata Alves</div>
            <div className="font-['ClashDisplay-Regular'] text-xs text-white/40">CTO, Grupo Meridian</div>
          </div>
        </div>
      </div>
    </section>
