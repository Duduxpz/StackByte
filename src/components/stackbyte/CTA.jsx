  ...
  return (
    <section id="contato" className="bg-[#FD7B01] py-20">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-6 text-center">
        <h2 className="max-w-xl text-3xl font-semibold text-black md:text-4xl">
        ...
        <a
          ...
          className="rounded-full bg-black px-7 py-3 text-sm font-medium text-white transition-opacity hover:opacity-90"
        >
